...
const textReggexPatternEmail = r'^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$';
...
const textReggexPatternByString =  r'^[a-zA-Z ]{2,50}$';
const textInvalidDataFormat = 'El valor ingresado no es un texto valido';
...
const textReggexPatternByNumber = r'^[0-9]$';
